...
function wpshout_react_header_enqueue_scripts() {
	...
	wp_enqueue_script( 'wpshout-react-header', plugin_dir_url( __FILE__ ) . 'react/shopping-list/static/js/main.c4ddab5e.js' );
	wp_enqueue_style( 'wpshout-react-header', plugin_dir_url( __FILE__ ) . 'react/shopping-list/static/css/main.279176be.css' );
}
